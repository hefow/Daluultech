      ...
      <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
        ...
        <div className="overflow-hidden bg-white rounded-xl">
          <div className="p-6">
            ...
            <p className="mt-6 text-lg font-medium text-gray-900">+252 612947216</p>
            <p className="mt-1 text-lg font-medium text-gray-900">+252 683581490</p>
          </div>
        </div>
        ...
        <div className="overflow-hidden bg-white rounded-xl">
          <div className="p-6">
            ...
            <p className="mt-6 text-lg font-medium text-gray-900">Daluultech@gmail.com</p>
            <p className="mt-1 text-lg font-medium text-gray-900">ahmedhefow11@gmail.com</p>
          </div>
        </div>
        ...
        <div className="overflow-hidden bg-white rounded-xl">
          <div className="p-6">
            ...
            <p className="mt-6 text-lg font-medium leading-relaxed text-gray-900">
              streat digfeer,mogadishu,somalia
            </p>
          </div>
        </div>
      </div>
